...
export default function LiveFieldImpact({ metrics = DEFAULT_METRICS, className = '', loading }) {
  if (loading) {
    return (
      <div className={`bg-white border border-slate-100 rounded-3xl p-5 shadow-xs ${className} animate-pulse`}>
