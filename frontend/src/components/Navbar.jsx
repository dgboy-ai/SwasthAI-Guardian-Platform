        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            {user ? (
              ...
              <>
                <Link to="/pricing" className="px-4 py-2 text-[11px] font-black text-slate-700 hover:text-emerald-600 uppercase tracking-widest transition-colors">Pricing</Link>
